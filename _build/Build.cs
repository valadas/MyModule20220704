...
internal class Build : NukeBuild
{
    ...
    private const string prodViewsPath = "/DesktopModules/MyModule20220704/resources/scripts/era-mymodule20220704/";
    ...
    Target DeployFrontEnd => _ => _
        ...
        .Executes(() =>
        {
            var scriptsDestination = RootDirectory / "resources" / "scripts" / "era-mymodule20220704";
            EnsureCleanDirectory(scriptsDestination);
            CopyDirectoryRecursively(RootDirectory / "module.web" / "dist" / "era-mymodule20220704", scriptsDestination, DirectoryExistsPolicy.Merge);
        });
    ...
    Target Swagger => _ => _
        ...
        .Executes(() =>
        {
            ...
            NSwagTasks.NSwagWebApiToOpenApi(c => c
                .AddAssembly(RootDirectory / "bin" / Configuration / "Eraware.Modules.MyModule20220704.dll")
                .SetInfoTitle("Eraware My Module 20220704")
