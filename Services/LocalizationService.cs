...
namespace Eraware.Modules.MyModule20220704.Services
{
    ...
    using static Eraware.Modules.MyModule20220704.ViewModels.LocalizationViewModel;
    ...
    public class LocalizationService : ILocalizationService
    {
            ...
            get
            {
                if (string.IsNullOrWhiteSpace(this.resourceFileRoot))
                {
                    this.resourceFileRoot = HostingEnvironment.MapPath(
                        "~/DesktopModules/MyModule20220704/resources/App_LocalResources/");
                }
        ...
        public LocalizationService()
        {
            ...
            this.cacheKey = "Eraware.Modules.MyModule20220704" + "_Localization_" + Thread.CurrentThread.CurrentCulture;
